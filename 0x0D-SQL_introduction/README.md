...
* Write a script that lists all the tablble second_table in the database hbtn_0c_0 in your MySQL server and add multiples rows.
...
---es of a database in your MySQL server.
